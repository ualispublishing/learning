...
- Canonical generated total: **846**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **126/360**; A1-A2 generation complete and B1 generation in progress.
...
Continue **Urdu B1**, starting from Unit 2 / sequence 7, under:
...
B1 Unit 2 uses the roadmap theme **work and workplace choices** with `profile`, `workplace scenario`, and `email` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B1 Unit 2 / sequence 7** using the B1 Unit 2 roadmap theme `work and workplace choices`.
