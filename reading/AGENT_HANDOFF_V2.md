...
- Canonical generated total: **888**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **168/360**; A1-A2 generation complete and B1 generation in progress.
...
Continue **Urdu B1**, starting from Unit 9 / sequence 49, under:
...
B1 Unit 9 uses the roadmap theme **public life and community choices** with `local report`, `proposal`, and `viewpoint` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B1 Unit 9 / sequence 49** using the B1 Unit 9 roadmap theme `public life and community choices`.
