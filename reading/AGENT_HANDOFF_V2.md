...
- Canonical generated total: **936**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **216/360**; A1-B1 generation complete and B2 generation in progress.
...
Continue **Urdu B2**, starting from Unit 7 / sequence 37, under:
...
B2 Unit 7 uses the roadmap theme **arts and interpretation** with `review`, `profile`, and `critical comparison` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B2 Unit 7 / sequence 37** using the B2 Unit 7 roadmap theme `arts and interpretation`.
