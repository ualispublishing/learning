...
- Canonical generated total: **960**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **240/360**; A1-B2 generation complete and C1 generation in progress.
...
Continue **Urdu C1**, starting from Unit 1 / sequence 1, under:
...
C1 Unit 1 uses the roadmap theme **research and evidence** with `academic-style synthesis`, `methods explanation`, and `critique` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu C1 Unit 1 / sequence 1** using the C1 Unit 1 roadmap theme `research and evidence`.
