...
- Canonical generated total: **918**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **198/360**; A1-B1 generation complete and B2 generation in progress.
...
Continue **Urdu B2**, starting from Unit 4 / sequence 19, under:
...
B2 Unit 4 uses the roadmap theme **cities and design** with `report`, `proposal`, and `critique` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B2 Unit 4 / sequence 19** using the B2 Unit 4 roadmap theme `cities and design`.
