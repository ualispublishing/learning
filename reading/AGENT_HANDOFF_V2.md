...
- Canonical generated total: **978**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **258/360**; A1-B2 generation complete and C1 generation in progress.
...
Continue **Urdu C1**, starting from Unit 4 / sequence 19, under:
...
C1 Unit 4 uses the roadmap theme **language, identity, and society** with `essay`, `analysis`, and `paired viewpoints` genres.
