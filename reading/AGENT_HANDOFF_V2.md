...
- Canonical generated total: **942**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **222/360**; A1-B1 generation complete and B2 generation in progress.
...
Continue **Urdu B2**, starting from Unit 8 / sequence 43, under:
...
B2 Unit 8 uses the roadmap theme **history and explanation** with `historical account`, `causal analysis`, and `source comparison` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B2 Unit 8 / sequence 43** using the B2 Unit 8 roadmap theme `history and explanation`.
