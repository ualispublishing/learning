...
- Canonical generated total: **930**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **210/360**; A1-B1 generation complete and B2 generation in progress.
...
Continue **Urdu B2**, starting from Unit 6 / sequence 31, under:
...
B2 Unit 6 uses the roadmap theme **digital life and privacy** with `analysis`, `policy-style summary`, and `paired opinions` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B2 Unit 6 / sequence 31** using the B2 Unit 6 roadmap theme `digital life and privacy`.
