...
- Canonical generated total: **816**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **96/360**; A1 generation complete and A2 generation in progress.
- Urdu A2 canonical path: `reading/urdu/a2/passages.jsonl`; Units 1-6 currently contain sequences 1-36.
...
Continue **Urdu A2**, starting from Unit 7 / sequence 37, under:
...
Unit 7 uses the roadmap theme **community events and simple news** with `brief news report`, `announcement`, and `reaction` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu A2 Unit 7 / sequence 37** using the Unit 7 roadmap theme `community events and simple news`.
