...
- Canonical generated total: **954**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **234/360**; A1-B1 generation complete and B2 generation in progress.
...
Continue **Urdu B2**, starting from Unit 10 / sequence 55, under:
...
B2 Unit 10 uses the roadmap theme **B2 synthesis** with `paired long texts`, `integrated analysis`, and `checkpoint` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B2 Unit 10 / sequence 55** using the B2 Unit 10 roadmap theme `B2 synthesis`.
