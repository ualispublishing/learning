...
- Canonical generated total: **852**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **132/360**; A1-A2 generation complete and B1 generation in progress.
...
Continue **Urdu B1**, starting from Unit 3 / sequence 13, under:
...
B1 Unit 3 uses the roadmap theme **technology in daily life** with `explanatory article`, `opinion`, and `story` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B1 Unit 3 / sequence 13** using the B1 Unit 3 roadmap theme `technology in daily life`.
