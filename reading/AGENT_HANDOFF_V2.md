...
- Canonical generated total: **966**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **246/360**; A1-B2 generation complete and C1 generation in progress.
...
Continue **Urdu C1**, starting from Unit 2 / sequence 7, under:
...
C1 Unit 2 uses the roadmap theme **professional judgment** with `briefing`, `case analysis`, and `recommendation` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu C1 Unit 2 / sequence 7** using the C1 Unit 1 roadmap theme `professional judgment`.
