...
- Canonical generated total: **1044**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **324/360**; A1-C1 generation complete and C2 generation in progress.
...
Continue **Urdu C2**, starting from Unit 5 / sequence 25, under:
...
C2 Unit 5 uses the roadmap theme **literary style and rhetoric** with `literary prose`, `critical analysis`, and `rhetorical commentary` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu C2 Unit 5 / sequence 25** using the C2 Unit 5 roadmap theme `literary style and rhetoric`.
