...
- Canonical generated total: **882**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **162/360**; A1-A2 generation complete and B1 generation in progress.
...
Continue **Urdu B1**, starting from Unit 8 / sequence 43, under:
...
B1 Unit 8 uses the roadmap theme **media and information** with `news-style report`, `commentary`, and `comparison` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B1 Unit 8 / sequence 43** using the B1 Unit 8 roadmap theme `media and information`.
