...
- Canonical generated total: **972**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **252/360**; A1-B2 generation complete and C1 generation in progress.
...
Continue **Urdu C1**, starting from Unit 3 / sequence 13, under:
...
C1 Unit 3 uses the roadmap theme **institutions and incentives** with `analysis`, `commentary`, and `policy note` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu C1 Unit 3 / sequence 13** using the C1 Unit 3 roadmap theme `institutions and incentives`.
