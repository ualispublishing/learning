...
- Canonical generated total: **894**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **174/360**; A1-A2 generation complete and B1 generation in progress.
...
Continue **Urdu B1**, starting from Unit 10 / sequence 55, under:
...
B1 Unit 10 uses the roadmap theme **B1 synthesis** with `longer integrated article`, `paired short texts`, and `checkpoint` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B1 Unit 10 / sequence 55** using the B1 Unit 10 roadmap theme `B1 synthesis`.
