...
- Canonical generated total: **924**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **204/360**; A1-B1 generation complete and B2 generation in progress.
...
Continue **Urdu B2**, starting from Unit 5 / sequence 25, under:
...
B2 Unit 5 uses the roadmap theme **climate and uncertainty** with `evidence summary`, `news analysis`, and `argument` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B2 Unit 5 / sequence 25** using the B2 Unit 5 roadmap theme `climate and uncertainty`.
