...
- Canonical generated total: **948**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **228/360**; A1-B1 generation complete and B2 generation in progress.
...
Continue **Urdu B2**, starting from Unit 9 / sequence 49, under:
...
B2 Unit 9 uses the roadmap theme **public policy and trade-offs** with `briefing`, `argument`, and `counterargument` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu B2 Unit 9 / sequence 49** using the B2 Unit 9 roadmap theme `public policy and trade-offs`.
