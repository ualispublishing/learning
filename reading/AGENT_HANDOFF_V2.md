...
- Canonical generated total: **990**.
- Arabic: **360/360**, A1-C2 generation complete.
- French: **360/360**, A1-C2 generation complete.
- Urdu: **270/360**; A1-B2 generation complete and C1 generation in progress.
...
Continue **Urdu C1**, starting from Unit 6 / sequence 31, under:
...
C1 Unit 6 uses the roadmap theme **law, rights, and interpretation** with `case-style explanation`, `argument`, and `commentary` genres.
...
Run `python reading/tools/validate_continuation_state.py`; if it passes, resume guarded generation at **Urdu C1 Unit 6 / sequence 31** using the C1 Unit 6 roadmap theme `law, rights, and interpretation`.
