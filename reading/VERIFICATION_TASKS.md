...
Current release position: fresh deterministic revalidation is **FAIL** with **1848** open evidence findings; educator/publication release remains **not ready** under the current assurance profile.

Fresh deterministic evidence: `reading/audit/arabic_fresh_deterministic_revalidation_2026-08-30.json` — 360 records, 3,600 questions, 3,600 answers; status **FAIL**; open findings **1848**. This is a release-evidence gate, not semantic approval.
