...
ROOT=Path(__file__).resolve().parents[2]; R=ROOT/'reading'; P=R/'VERIFICATION_TASKS.md'; REL=R/'RELEASE_STATUS.json'; DEC=R/'audit/arabic_gate_b_decisions_2026-08-30/c2_u08.json'
REVIEWED=348; WITH=296; FINDINGS=529; BLOCKERS=1128
def rep(t,o,n):
...
def main():
 ...
 t=P.read_text(); marker='reading/audit/arabic_gate_b_decisions_2026-08-30/c2_u08.json'
 ...
 c7='- [x] Arabic C2 Unit 7 Gate B batch: reviewed 6 passages / 60 questions / 60 answers; closed 4 fresh summary-answer assessment-alignment findings across 4 records and recorded 2 clean PASS records with hash-bound decision evidence;'
