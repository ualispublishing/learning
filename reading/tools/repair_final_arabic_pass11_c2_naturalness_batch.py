...
'ar-c2-u02-p06':[('وفي مطالبة تعتمد وثيقة يقال إنها تزوير','وفي مطالبة تعتمد وثيقة يقال إن فيها تزويرًا'),('ثلاثة خرائط متداخلة','ثلاث خرائط متداخلة')],
...
'ar-c2-u04-p06':[('لأن الزمن التي تعالجه المحاسبة مختلف','لأن الزمن الذي تعالجه المحاسبة مختلف'),('المؤشرات القائدة والمؤشرات المتأخرة','المؤشرات الاستباقية والمؤشرات المتأخرة'),('حساسية لا يخفى خلف رقم متوسط','حساسية لا تخفى خلف رقم متوسط')],
