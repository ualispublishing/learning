...
'ar-c2-u05-p01':[('حول ما يحتاج إلى التركيز','حول ما ينبغي التركيز عليه'),('اعتراض اعتراضي بين شرطتين','عبارة اعتراضية بين شرطتين')],
...
'ar-c2-u09-p05':[('وفتح قناة بلاغ تسمح','وفتح قناة للإبلاغ تسمح'),('النظام الجديد فترة معينة','النظام الجديد خلال فترة معينة')],
