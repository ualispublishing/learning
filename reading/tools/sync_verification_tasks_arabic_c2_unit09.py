...
ROOT=Path(__file__).resolve().parents[2]; R=ROOT/'reading'; P=R/'VERIFICATION_TASKS.md'; REL=R/'RELEASE_STATUS.json'; DEC=R/'audit/arabic_gate_b_decisions_2026-08-30/c2_u09.json'
REVIEWED=354; WITH=302; FINDINGS=541; BLOCKERS=1104
def rep(t,o,n):
...
def main():
 ...
 c8='- [x] Arabic C2 Unit 8 Gate B batch: reviewed 6 passages / 60 questions / 60 answers; closed 6 fresh summary-answer assessment-alignment findings across all 6 records with hash-bound decision evidence;'
