...
ROOT=Path(__file__).resolve().parents[2]; R=ROOT/'reading'; P=R/'VERIFICATION_TASKS.md'; REL=R/'RELEASE_STATUS.json'; DEC=R/'audit/arabic_gate_b_decisions_2026-08-30/c2_u02.json'
REVIEWED=312; WITH=265; FINDINGS=494; BLOCKERS=1272
def rep(t,o,n):
...
def main():
 ...
 c1='- [x] Arabic C2 Unit 1 Gate B batch: reviewed 6 passages / 60 questions / 60 answers; closed 6 fresh findings across all 6 records with hash-bound decision evidence;'
