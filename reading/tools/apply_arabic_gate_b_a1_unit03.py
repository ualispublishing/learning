...
TEXT_REPAIRS={
 'ar-a1-u03-p02':[
  ('في النهاية يكون عدد الأشياء في الحقيبة قليلًا، وكل شيء فيها له مكان في عشاء اليوم.','في النهاية يكون عدد الأشياء في الحقيبة قليلًا، وكلها أشياء لعشاء اليوم.')
 ],
 'ar-a1-u03-p03':[
