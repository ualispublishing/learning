...
ROOT=Path(__file__).resolve().parents[2]; R=ROOT/'reading'; P=R/'VERIFICATION_TASKS.md'; REL=R/'RELEASE_STATUS.json'; DEC=R/'audit/arabic_gate_b_decisions_2026-08-30/c2_u01.json'
REVIEWED=306; WITH=259; FINDINGS=488; BLOCKERS=1296
def rep(t,o,n):
...
def main():
 ...
 t=P.read_text(); marker='reading/audit/arabic_gate_b_decisions_2026-08-30/c2_u01.json'
 ...
 t=rep(t,'Fresh deterministic evidence: `reading/audit/arabic_fresh_deterministic_revalidation_2026-08-30.json` — 360 records, 3,600 questions, 3,600 answers; status **FAIL**; open findings **1320**. This is a release-evidence gate, not semantic approval.','Fresh deterministic evidence: `reading/audit/arabic_fresh_deterministic_revalidation_2026-08-30.json` — 360 records, 3,600 questions, 3,600 answers; status **FAIL**; open findings **1296**. This is a release-evidence gate, not semantic approval.')
 ...
 c10='- [x] Arabic C1 Unit 10 Gate B batch: reviewed 6 passages / 60 questions / 60 answers; closed 6 fresh findings across all 6 records with hash-bound decision evidence; C1 Gate B is complete and C2 Unit 1 is next;'
