...
ROOT=Path(__file__).resolve().parents[2]; R=ROOT/'reading'; P=R/'VERIFICATION_TASKS.md'; REL=R/'RELEASE_STATUS.json'; DEC=R/'audit/arabic_gate_b_decisions_2026-08-30/c2_u03.json'
REVIEWED=318; WITH=269; FINDINGS=498; BLOCKERS=1248
def rep(t,o,n):
...
def main():
 ...
 t=P.read_text(); marker='reading/audit/arabic_gate_b_decisions_2026-08-30/c2_u03.json'
 ...
 c2='- [x] Arabic C2 Unit 2 Gate B batch: reviewed 6 passages / 60 questions / 60 answers; closed 6 fresh summary-answer alignment findings across all 6 records with hash-bound decision evidence;'
