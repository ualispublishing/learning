...
ROOT=Path(__file__).resolve().parents[2]; R=ROOT/'reading'; P=R/'VERIFICATION_TASKS.md'; REL=R/'RELEASE_STATUS.json'; DEC=R/'audit/arabic_gate_b_decisions_2026-08-30/c2_u06.json'
REVIEWED=336; WITH=286; FINDINGS=519; BLOCKERS=1176
def rep(t,o,n):
...
def main():
 ...
 t=P.read_text(); marker='reading/audit/arabic_gate_b_decisions_2026-08-30/c2_u06.json'
 ...
 c5='- [x] Arabic C2 Unit 5 Gate B batch: reviewed 6 passages / 60 questions / 60 answers; closed 5 fresh summary-answer assessment-alignment findings across 5 records and recorded 1 clean PASS record with hash-bound decision evidence;'
