...
'ar-c1-u03-p04': [('فقد تتحول إلى طقس شرعي','فقد تتحول إلى طقس لإضفاء الشرعية')],
...
'ar-c1-u04-p03': [('ضوضاء يجب متوسطها','ضوضاء يجب أخذ متوسطها'),('قبول التسجيل نفسه قد يختار متحدثين أكثر راحة','قد يؤدي قبول التسجيل نفسه إلى اختيار متحدثين أكثر راحة')],
