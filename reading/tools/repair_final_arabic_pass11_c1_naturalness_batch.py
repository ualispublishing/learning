...
'ar-c1-u01-p06': [('لا كما هي المجموعة كلها بل حسبما جُمعت','لا كما هي المجموعة كلها بل كيف جُمعت'),('استخدمت سلمى خريطتها على دراسة خيالية جديدة','طبقت سلمى خريطتها على دراسة خيالية جديدة')],
