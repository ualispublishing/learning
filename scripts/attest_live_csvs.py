...
FILES={'arabic_top1000.csv':1000,'arabic_top3000.csv':2000,'french_top1000.csv':1000,'french_top3000.csv':2000,'urdu_top1000.csv':1000,'urdu_top3000.csv':2000,'arabic_phrase_bank.csv':1078}
...
def main():
 ...
 for name,expected in FILES.items():
  ...
  if blocking: problems.append(f'duplicate_cards={sum(len(g["rows"])-1 for g in blocking)}')
 ...
 report['overall_gate']='PASS' if not report['problems'] else 'FAIL'; report['scope']='Learner-facing root CSVs only; legitimate same-surface/different-meaning-and-POS homographs are recorded but are not duplicate-card failures.'
